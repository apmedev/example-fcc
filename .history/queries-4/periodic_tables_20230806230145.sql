...
--
-- Name: types_type_seq; Type: SEQUENCE; Schema: public; Owner: freecodecamp
--
...
ALTER TABLE public.types_type_seq OWNER TO freecodecamp;

--
-- Name: types_type_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: freecodecamp
--
...
--
-- Name: types_type_seq; Type: SEQUENCE SET; Schema: public; Owner: freecodecamp
--
